...
public class ImgSaver {
    ...
    public ImgSaver setFileName(String fileName) {
        this.fileName = fileName;
        return this;
    }

    public ImgSaver setExternal(boolean external) {
        this.external = external;
        return this;
    }

    public ImgSaver setDirectoryName(String directoryName) {
    ...
    private File createFile() {
        ...
        if(!directory.exists() && !directory.mkdirs()){
            Log.e("ImgSaver","Error creating directory " + directory);
        }
